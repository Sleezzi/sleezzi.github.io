...
`,
	...
	},
	{
		...
		name: "Vigidev",
		description: "Vigidev assure la sécurité de vos sites en contrôle d'accès, vidéoprotection et anti-intrusion, centralisée depuis notre suite logicielle Octopus.\nEn plus d'être concepteur de solutions de sûreté, Vigidev assure un accompagnement personnalisé auprès des installateurs, bureaux d'études et utilisateurs finaux.",
